...
array_of_args_extract(const msgpack_object_array *const args, const size_t at_index)
{
...
Eina_Bool
arg_t_int_get(const msgpack_object *const obj, t_int *const arg)
{
...
Eina_Bool
arg_uint_get(const msgpack_object *const obj, unsigned int *const arg)
{
  if (EINA_UNLIKELY(obj->type != MSGPACK_OBJECT_POSITIVE_INTEGER))
  {
...
Eina_Bool
arg_color_get(const msgpack_object *const obj, union color *const arg)
{
  if (EINA_UNLIKELY(obj->type != MSGPACK_OBJECT_POSITIVE_INTEGER))
  {
...
Eina_Bool
arg_stringshare_get(const msgpack_object *const obj, Eina_Stringshare **const arg)
{
...
Eina_Bool
arg_bool_get(const msgpack_object *const obj, Eina_Bool *const arg)
{
